...
import { switchMap, map, tap, finalize, refCount, mergeMap, filter, take, takeUntil, catchError, first, concatMap, scan, defaultIfEmpty, last as last$1, startWith, takeLast } from 'rxjs/operators';
...
new InjectionToken(ngDevMode ? 'view transition options' : '');
...
//# sourceMappingURL=angular-router-upgrade.js.map
