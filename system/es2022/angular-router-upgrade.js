...
System.register(['@angular/common', '@angular/core', '@angular/upgrade/static', 'rxjs', 'rxjs/operators', '@angular/platform-browser'], (function (exports) {
    ...
    return {
        ...
        execute: (function () {
            ...
            exports({
                locationSyncBootstrapListener: locationSyncBootstrapListener,
                setUpLocationSync: setUpLocationSync
            });
    ...
    `);
             ...
             * @publicApi
             */
            const RouterUpgradeInitializer = exports("RouterUpgradeInitializer", {
