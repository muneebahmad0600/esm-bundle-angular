/* esm-bundle - @angular/upgrade@19.2.20 - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', 'tslib', '@angular/platform-browser-dynamic'], (function (exports) {
    'use strict';
    var Version, NgZone, ComponentFactoryResolver, Injector, ChangeDetectorRef, Testability, TestabilityRegistry, ApplicationRef, SimpleChange, _SIGNAL, EventEmitter, i0, Directive, Compiler, NgModule, resolveForwardRef, ElementRef, Inject, __decorate, __metadata, platformBrowserDynamic;
    return {
        setters: [function (module) {
            ...
            SimpleChange = module.SimpleChange;
            _SIGNAL = module.ɵSIGNAL;
            EventEmitter = module.EventEmitter;
            i0 = module;
            Directive = module.Directive;
            Compiler = module.Compiler;
            NgModule = module.NgModule;
            resolveForwardRef = module.resolveForwardRef;
            ...
            platformBrowserDynamic = module.platformBrowserDynamic;
        }],
        execute: (function () {
            ...
            function getUpgradeAppType($injector) {
              return $injector.has(UPGRADE_APP_TYPE_KEY) ? $injector.get(UPGRADE_APP_TYPE_KEY) : 0 /* UpgradeAppType.None */;
            }
            ...
            function matchesSelector(el, selector) {
              ...
              (elProto.matches ?? elProto.msMatchesSelector).call(el, selector) : false;
            }
            ...
            class UpgradeNg1ComponentAdapterBuilder {
              ...
              constructor(name) {
                ...
                MyClass = __decorate([Directive({
                  jit: true,
                  selector: selector,
                  inputs: this.inputsRename,
                  outputs: this.outputsRename,
                  standalone: false
                }), __metadata("design:paramtypes", [Object, Injector, ElementRef])], MyClass);
                this.type = MyClass;
              }
              extractBindings() {
            ...
            class UpgradeNg1ComponentAdapter {
              ...
              static ɵfac = function UpgradeNg1ComponentAdapter_Factory(__ngFactoryType__) {
                i0.ɵɵinvalidFactory();
              };
              static ɵdir = /* @__PURE__ */i0.ɵɵdefineDirective({
                type: UpgradeNg1ComponentAdapter,
            ...
            class UpgradeAdapter {
              ...
              declareNg1Module(modules = []) {
                ...
                ng1Module.constant(UPGRADE_APP_TYPE_KEY, 1 /* UpgradeAppType.Dynamic */).factory(INJECTOR_KEY, () => this.moduleRef.injector.get(Injector)).factory(LAZY_MODULE_REF, [INJECTOR_KEY, injector => ({
                  injector
                })]).constant(NG_ZONE_KEY, ngZone).factory(COMPILER_KEY, () => this.moduleRef.injector.get(Compiler)).config(['$provide', '$injector', (provide, ng1Injector) => {
                ...
                ng1Module.run(['$injector', '$rootScope', (ng1Injector, rootScope) => {
                  UpgradeNg1ComponentAdapterBuilder.resolve(this.ng1ComponentsToBeUpgraded, ng1Injector).then(() => {
                    // At this point we have ng1 injector and we have prepared
                    // ng1 components to be upgraded, we now can bootstrap ng2.
                    let DynamicNgUpgradeModule = class DynamicNgUpgradeModule {
                      ngDoBootstrap() {}
                    };
                    DynamicNgUpgradeModule = __decorate([NgModule({
                      jit: true,
                      providers: [{
                        provide: $INJECTOR,
                        useFactory: () => ng1Injector
                      }, {
                        provide: $COMPILE,
                        useFactory: () => ng1Injector.get($COMPILE)
                      }, this.upgradedProviders],
                      imports: [resolveForwardRef(this.ng2AppModule)]
                    })], DynamicNgUpgradeModule);
                    platformRef.bootstrapModule(DynamicNgUpgradeModule, [this.compilerOptions, {
                      ngZone
                    }]).then(ref => {
                      this.moduleRef = ref;
                      ngZone.run(() => {
                    ...
                    }).then(() => ng2BootstrapDeferred.resolve(ng1Injector), onError).then(() => {
...
//# sourceMappingURL=angular-upgrade.js.map
