...
System.register(['@angular/common', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/platform-browser'], (function (exports) {
    ...
    return {
        setters: [function (module) {
            ...
            HashLocationStrategy = module.HashLocationStrategy;
            LocationStrategy = module.LocationStrategy;
            PathLocationStrategy = module.PathLocationStrategy;
            LOCATION_INITIALIZED = module.LOCATION_INITIALIZED;
        }, function (module) {
            i0 = module;
            ...
            Input = module.Input;
            reflectComponentType = module.reflectComponentType;
            Component = module.Component;
            Compiler = module.Compiler;
            NgModuleFactory = module.NgModuleFactory;
            EnvironmentInjector = module.EnvironmentInjector;
            DestroyRef = module.DestroyRef;
            runInInjectionContext = module.runInInjectionContext;
            _Console = module.ɵConsole;
            _PendingTasksInternal = module.ɵPendingTasksInternal;
            _isPromise = module.ɵisPromise;
            _isNgModule = module.ɵisNgModule;
            isStandalone = module.isStandalone;
            _isInjectable = module.ɵisInjectable;
            createEnvironmentInjector = module.createEnvironmentInjector;
            NgZone = module.NgZone;
            afterNextRender = module.afterNextRender;
            __sanitizeUrlOrResourceUrl = module.ɵɵsanitizeUrlOrResourceUrl;
            ...
            provideAppInitializer = module.provideAppInitializer;
            ...
            of = module.of;
            ConnectableObservable = module.ConnectableObservable;
            Subject = module.Subject;
            from = module.from;
            BehaviorSubject = module.BehaviorSubject;
            EMPTY = module.EMPTY;
            Subscription = module.Subscription;
            isObservable = module.isObservable;
            concat = module.concat;
            defer = module.defer;
            throwError = module.throwError;
            EmptyError = module.EmptyError;
            pipe = module.pipe;
        }, function (module) {
            ...
            scan = module.scan;
            defaultIfEmpty = module.defaultIfEmpty;
            last$1 = module.last;
        ...
        execute: (function () {
             ...
             * @publicApi
             */
            const PRIMARY_OUTLET = exports("PRIMARY_OUTLET", 'primary');
            /**
             ...
             * @publicApi
             */
            var EventType; exports("EventType", EventType);
            (function (EventType) {
             ...
             * @publicApi
             */
            var NavigationCancellationCode; exports("NavigationCancellationCode", NavigationCancellationCode);
             ...
             * @publicApi
             */
            var NavigationSkippedCode; exports("NavigationSkippedCode", NavigationSkippedCode);
    ...
    `);
             ...
             * @publicApi
             */
            const ROUTER_OUTLET_DATA = exports("ROUTER_OUTLET_DATA", new InjectionToken(ngDevMode ? 'RouterOutlet data' : ''));
            /**
             * @description
             *
            ...
            } exports("RedirectCommand", RedirectCommand);
             ...
             * @publicApi
             */
            const ROUTER_CONFIGURATION = exports("ROUTER_CONFIGURATION", new InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'router config' : '', {
              providedIn: 'root',
              factory: () => ({})
            }));
             ...
             * @publicApi
             */
            const ROUTES = exports("ROUTES", new InjectionToken(ngDevMode ? 'ROUTES' : ''));
            ...
            } exports({ RouterLink: RouterLink, RouterLinkWithHref: RouterLink });
            (() => {
             ...
             * @publicApi
             */
            class PreloadingStrategy {} exports("PreloadingStrategy", PreloadingStrategy);
            /**
             * @description
             *
            ...
            const ROUTER_PROVIDERS = exports("ɵROUTER_PROVIDERS", [Location, {
             ...
             * @publicApi
             */
            const ROUTER_INITIALIZER = exports("ROUTER_INITIALIZER", new InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'Router Initializer' : ''));
