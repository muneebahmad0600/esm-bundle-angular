...
System.register(['@angular/common', '@angular/core'], (function (exports, module) {
  ...
  return {
    setters: [function (module) {
      ...
      _ChangeDetectionScheduler = module.ɵChangeDetectionScheduler;
  ...
  - There is a corresponding animation configuration named \`${name}\` defined in the \`animations\` field of the \`@Component\` decorator (see https://angular.dev/api/core/Component#animations).`);
      ...
      class AsyncAnimationRendererFactory {
        ...
        loadImpl() {
          ...
          const loadFn = () => this.moduleImpl ?? module.import('@angular/animations/browser').then(m => m);
      ...
      } exports("ɵAsyncAnimationRendererFactory", AsyncAnimationRendererFactory);
      (() => {
       ...
       */
      const ɵASYNC_ANIMATION_LOADING_SCHEDULER_FN = exports("ɵASYNC_ANIMATION_LOADING_SCHEDULER_FN", new InjectionToken(ngDevMode ? 'async_animation_loading_scheduler_fn' : ''));
