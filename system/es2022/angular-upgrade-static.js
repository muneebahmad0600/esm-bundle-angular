...
System.register(['@angular/core', '@angular/platform-browser'], (function (exports) {
    ...
    return {
        setters: [function (module) {
            ...
            _NG_MOD_DEF = module.ɵNG_MOD_DEF;
            ...
            _NOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR = module.ɵNOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR;
            PlatformRef = module.PlatformRef;
        }, function (module) {
        ...
        execute: (function () {
            ...
            exports({
                downgradeComponent: downgradeComponent,
                downgradeInjectable: downgradeInjectable,
                downgradeModule: downgradeModule,
            ...
            var angular1 = exports("ɵangular1", /*#__PURE__*/Object.freeze({
              __proto__: null,
              bootstrap: bootstrap,
              element: element,
              getAngularJSGlobal: getAngularJSGlobal,
            ...
            var constants = exports("ɵconstants", /*#__PURE__*/Object.freeze({
              __proto__: null,
            ...
            var util = exports("ɵutil", /*#__PURE__*/Object.freeze({
              __proto__: null,
              Deferred: Deferred,
              cleanData: cleanData,
            ...
            var upgrade_helper = exports("ɵupgradeHelper", /*#__PURE__*/Object.freeze({
              __proto__: null,
            ...
            function downgradeModule(moduleOrBootstrapFn) {
              ...
              module_(lazyModuleName, []).constant(UPGRADE_APP_TYPE_KEY, 3 /* ɵutil.UpgradeAppType.Lite */).factory(INJECTOR_KEY, [lazyInjectorKey, identity]).factory(lazyInjectorKey, () => {
                if (!injector) {
            ...
            class UpgradeModule {
              ...
              bootstrap(element$1, modules = [], config /*angular.IAngularBootstrapConfig*/) {
                ...
                // Create an ng1 module to bootstrap
                module_(INIT_MODULE_NAME, []).constant(UPGRADE_APP_TYPE_KEY, 2 /* ɵutil.UpgradeAppType.Static */).value(INJECTOR_KEY, this.injector).factory(LAZY_MODULE_REF, [INJECTOR_KEY, injector => ({
                  injector
              ...
              static ɵfac = function UpgradeModule_Factory(__ngFactoryType__) {
                return new (__ngFactoryType__ || UpgradeModule)(i0.ɵɵinject(i0.Injector), i0.ɵɵinject(i0.NgZone), i0.ɵɵinject(i0.PlatformRef));
              };
...
//# sourceMappingURL=angular-upgrade-static.js.map
