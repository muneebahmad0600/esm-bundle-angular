/* esm-bundle - @angular/core/primitives/signals@19.2.19 - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
    ...
    return {
        execute: (function () {
            ...
            exports({
                ...
                producerIncrementEpoch: producerIncrementEpoch,
                producerMarkClean: producerMarkClean,
                ...
                runPostSignalSetFn: runPostSignalSetFn,
             ...
             */
            const SIGNAL = exports("SIGNAL", /* @__PURE__ */Symbol('SIGNAL'));
            ...
            const REACTIVE_NODE = exports("REACTIVE_NODE", {
              version: 0,
              lastCleanEpoch: 0,
              dirty: false,
            ...
            // a side-effect, ending up preserving `COMPUTED_NODE` and `REACTIVE_NODE`.
            // TODO: remove when https://github.com/evanw/esbuild/issues/3392 is resolved.
            const SIGNAL_NODE = exports("SIGNAL_NODE", /* @__PURE__ */(() => {
              return {
                ...REACTIVE_NODE,
                equal: defaultEquals,
                value: undefined,
...
//# sourceMappingURL=angular-core-primitives-signals.js.map
