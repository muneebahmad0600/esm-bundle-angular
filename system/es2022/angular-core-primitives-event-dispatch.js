/* esm-bundle - @angular/core/primitives/event-dispatch@19.2.20 - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register([], (function (exports) {
    ...
    return {
        execute: (function () {
             ...
             * @returns bool
             */
            const isCaptureEventType = exports("isCaptureEventType", eventType => CAPTURE_EVENT_TYPES.indexOf(eventType) >= 0);
             ...
             */
            const isEarlyEventType = exports("isEarlyEventType", eventType => EARLY_EVENT_TYPES.indexOf(eventType) >= 0);
            ...
            const EventPhase = exports("EventPhase", {
              REPLAY: 101
            });
...
//# sourceMappingURL=angular-core-primitives-event-dispatch.js.map
