/* esm-bundle - @angular/common@19.2.19 - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', 'rxjs'], (function (exports) {
    'use strict';
    var InjectionToken, i0, inject, Injectable, Optional, Inject, __inject, LOCALE_ID, _stringify, Directive, Input, createNgModule, NgModuleRef, _RuntimeError, Host, Attribute, RendererStyleFlags2, _isPromise, _isSubscribable, Pipe, DEFAULT_CURRENCY_CODE, NgModule, _getLocalePluralCase, untracked, _findLocaleData, _LocaleDataIndex, _getLocaleCurrencyCode, Version, __defineInjectable, PLATFORM_ID, _formatRuntimeError, _IMAGE_CONFIG, Renderer2, ElementRef, Injector, DestroyRef, _performanceMarkFeature, NgZone, ApplicationRef, booleanAttribute, numberAttribute, _IMAGE_CONFIG_DEFAULTS, _unwrapSafeValue, ChangeDetectorRef, _registerLocaleData, Subject;
    return {
        setters: [function (module) {
            ...
            Inject = module.Inject;
            __inject = module.ɵɵinject;
            LOCALE_ID = module.LOCALE_ID;
            _stringify = module.ɵstringify;
            Directive = module.Directive;
            Input = module.Input;
            createNgModule = module.createNgModule;
            NgModuleRef = module.NgModuleRef;
            _RuntimeError = module.ɵRuntimeError;
            Host = module.Host;
            Attribute = module.Attribute;
            RendererStyleFlags2 = module.RendererStyleFlags2;
            _isPromise = module.ɵisPromise;
            _isSubscribable = module.ɵisSubscribable;
            Pipe = module.Pipe;
            DEFAULT_CURRENCY_CODE = module.DEFAULT_CURRENCY_CODE;
            NgModule = module.NgModule;
            _getLocalePluralCase = module.ɵgetLocalePluralCase;
            untracked = module.untracked;
            _findLocaleData = module.ɵfindLocaleData;
            _LocaleDataIndex = module.ɵLocaleDataIndex;
            _getLocaleCurrencyCode = module.ɵgetLocaleCurrencyCode;
            Version = module.Version;
            __defineInjectable = module.ɵɵdefineInjectable;
            PLATFORM_ID = module.PLATFORM_ID;
            _formatRuntimeError = module.ɵformatRuntimeError;
            _IMAGE_CONFIG = module.ɵIMAGE_CONFIG;
            ...
            booleanAttribute = module.booleanAttribute;
            numberAttribute = module.numberAttribute;
            _IMAGE_CONFIG_DEFAULTS = module.ɵIMAGE_CONFIG_DEFAULTS;
            _unwrapSafeValue = module.ɵunwrapSafeValue;
            ChangeDetectorRef = module.ChangeDetectorRef;
            _registerLocaleData = module.ɵregisterLocaleData;
            exports("IMAGE_CONFIG", module.ɵIMAGE_CONFIG);
        }, function (module) {
        ...
        execute: (function () {
             ...
             * @publicApi
             */
            const DOCUMENT = exports("DOCUMENT", new InjectionToken(ngDevMode ? 'DocumentToken' : ''));
             ...
             */
            class DomAdapter {} exports("ɵDomAdapter", DomAdapter);
             ...
             * @publicApi
             */
            const LOCATION_INITIALIZED = exports("LOCATION_INITIALIZED", new InjectionToken(ngDevMode ? 'Location Initialized' : ''));
            /**
             ...
             * @publicApi
             */
            const APP_BASE_HREF = exports("APP_BASE_HREF", new InjectionToken(ngDevMode ? 'appBaseHref' : ''));
            /**
             * @description
             ...
             */
            var NumberFormatStyle; exports("NumberFormatStyle", NumberFormatStyle);
             ...
             */
            var Plural; exports("Plural", Plural);
            (function (Plural) {
             ...
             */
            var FormStyle; exports("FormStyle", FormStyle);
            (function (FormStyle) {
             ...
             * @deprecated locale data getters are deprecated
             */
            var TranslationWidth; exports("TranslationWidth", TranslationWidth);
             ...
             */
            var FormatWidth; exports("FormatWidth", FormatWidth);
             ...
             */
            const NumberSymbol = exports("NumberSymbol", {
              /**
               * Decimal separator.
             ...
             */
            var WeekDay; exports("WeekDay", WeekDay);
            (function (WeekDay) {
             ...
             */
            const getLocalePluralCase = exports("getLocalePluralCase", _getLocalePluralCase);
            ...
            } exports({ NgFor: NgForOf, NgForOf: NgForOf });
            (() => {
             ...
             */
            const DATE_PIPE_DEFAULT_TIMEZONE = exports("DATE_PIPE_DEFAULT_TIMEZONE", new InjectionToken(ngDevMode ? 'DATE_PIPE_DEFAULT_TIMEZONE' : ''));
            /**
             ...
             * ```
             */
            const DATE_PIPE_DEFAULT_OPTIONS = exports("DATE_PIPE_DEFAULT_OPTIONS", new InjectionToken(ngDevMode ? 'DATE_PIPE_DEFAULT_OPTIONS' : ''));
            /**
             * @ngModule CommonModule
             * @description
             *
            ...
            const PLATFORM_BROWSER_ID = exports("ɵPLATFORM_BROWSER_ID", 'browser');
            const PLATFORM_SERVER_ID = exports("ɵPLATFORM_SERVER_ID", 'server');
            /**
             ...
             * @publicApi
             */
            class XhrFactory {} exports("XhrFactory", XhrFactory);
             ...
             * @publicApi
             */
            const IMAGE_LOADER = exports("IMAGE_LOADER", new InjectionToken(ngDevMode ? 'ImageLoader' : '', {
              providedIn: 'root',
             ...
             * @publicApi
             */
            const provideCloudflareLoader = exports("provideCloudflareLoader", createImageLoader(createCloudflareUrl, ngDevMode ? ['https://<ZONE>/cdn-cgi/image/<OPTIONS>/<SOURCE-IMAGE>'] : undefined));
             ...
             * @publicApi
             */
            const provideCloudinaryLoader = exports("provideCloudinaryLoader", createImageLoader(createCloudinaryUrl, ngDevMode ? ['https://res.cloudinary.com/mysite', 'https://mysite.cloudinary.com', 'https://subdomain.mysite.com'] : undefined));
             ...
             * @publicApi
             */
            const provideImageKitLoader = exports("provideImageKitLoader", createImageLoader(createImagekitUrl, ngDevMode ? ['https://ik.imagekit.io/mysite', 'https://subdomain.mysite.com'] : undefined));
             ...
             * @publicApi
             */
            const provideImgixLoader = exports("provideImgixLoader", createImageLoader(createImgixUrl, ngDevMode ? ['https://somepath.imgix.net/'] : undefined));
             ...
             * @publicApi
             */
            const PRECONNECT_CHECK_BLOCKLIST = exports("PRECONNECT_CHECK_BLOCKLIST", new InjectionToken(ngDevMode ? 'PRECONNECT_CHECK_BLOCKLIST' : ''));
            /**
...
//# sourceMappingURL=angular-common.js.map
