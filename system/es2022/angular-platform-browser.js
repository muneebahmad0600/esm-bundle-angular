...
System.register(['@angular/common', '@angular/core', '@angular/common/http'], (function (exports) {
  ...
  return {
    setters: [function (module) {
      ...
      exports("ɵgetDOM", module.ɵgetDOM);
    }, function (module) {
      ...
      _internalCreateApplication = module.ɵinternalCreateApplication;
      _Console = module.ɵConsole;
      Injector = module.Injector;
      forwardRef = module.forwardRef;
      _XSS_SECURITY_URL = module.ɵXSS_SECURITY_URL;
      SecurityContext = module.SecurityContext;
      _allowSanitizationBypassAndThrow = module.ɵallowSanitizationBypassAndThrow;
      _unwrapSafeValue = module.ɵunwrapSafeValue;
      __sanitizeUrl = module.ɵ_sanitizeUrl;
      __sanitizeHtml = module.ɵ_sanitizeHtml;
      _bypassSanitizationTrustHtml = module.ɵbypassSanitizationTrustHtml;
      _bypassSanitizationTrustStyle = module.ɵbypassSanitizationTrustStyle;
      _bypassSanitizationTrustScript = module.ɵbypassSanitizationTrustScript;
      _bypassSanitizationTrustUrl = module.ɵbypassSanitizationTrustUrl;
      _bypassSanitizationTrustResourceUrl = module.ɵbypassSanitizationTrustResourceUrl;
      Version = module.Version;
      makeEnvironmentProviders = module.makeEnvironmentProviders;
      _withDomHydration = module.ɵwithDomHydration;
      _withEventReplay = module.ɵwithEventReplay;
      _withI18nSupport = module.ɵwithI18nSupport;
      _withIncrementalHydration = module.ɵwithIncrementalHydration;
      ApplicationRef = module.ApplicationRef;
      ENVIRONMENT_INITIALIZER = module.ENVIRONMENT_INITIALIZER;
      _ZONELESS_ENABLED = module.ɵZONELESS_ENABLED;
      _formatRuntimeError = module.ɵformatRuntimeError;
    }, function (module) {
      _withHttpTransferCache = module.ɵwithHttpTransferCache;
    }],
    execute: (function () {
       ...
       * @publicApi
       */
      const EVENT_MANAGER_PLUGINS = exports("EVENT_MANAGER_PLUGINS", new InjectionToken(ngDevMode ? 'EventManagerPlugins' : ''));
      /**
       ...
       * @publicApi
       */
      const REMOVE_STYLES_ON_COMPONENT_DESTROY = exports("REMOVE_STYLES_ON_COMPONENT_DESTROY", new InjectionToken(ngDevMode ? 'RemoveStylesOnCompDestroy' : '', {
        providedIn: 'root',
  ...
  - There is a corresponding animation configuration named \`${name}\` defined in the \`animations\` field of the \`@Component\` decorator (see https://angular.dev/api/core/Component#animations).`);
       ...
       * @publicApi
       */
      const platformBrowser = exports("platformBrowser", createPlatformFactory(platformCore, 'browser', INTERNAL_BROWSER_PLATFORM_PROVIDERS));
      /**
       ...
       * @publicApi
       */
      const HAMMER_GESTURE_CONFIG = exports("HAMMER_GESTURE_CONFIG", new InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'HammerGestureConfig' : ''));
      /**
       ...
       * @publicApi
       */
      const HAMMER_LOADER = exports("HAMMER_LOADER", new InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'HammerLoader' : ''));
      /**
       ...
       * @publicApi
       */
      var HydrationFeatureKind; exports("HydrationFeatureKind", HydrationFeatureKind);
      ...
      })(HydrationFeatureKind || (exports("HydrationFeatureKind", HydrationFeatureKind = {})));
      /**
