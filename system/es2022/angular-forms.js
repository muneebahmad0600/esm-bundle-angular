...
System.register(['@angular/core', '@angular/common', 'rxjs', 'rxjs/operators'], (function (exports) {
  ...
  return {
    ...
    execute: (function () {
       ...
       * @publicApi
       */
      const NG_VALUE_ACCESSOR = exports("NG_VALUE_ACCESSOR", new InjectionToken(ngDevMode ? 'NgValueAccessor' : ''));
       ...
       * @publicApi
       */
      const COMPOSITION_BUFFER_MODE = exports("COMPOSITION_BUFFER_MODE", new InjectionToken(ngDevMode ? 'CompositionEventMode' : ''));
      /**
       ...
       * @publicApi
       */
      const NG_VALIDATORS = exports("NG_VALIDATORS", new InjectionToken(ngDevMode ? 'NgValidators' : ''));
      /**
       * @description
       ...
       * @publicApi
       */
      const NG_ASYNC_VALIDATORS = exports("NG_ASYNC_VALIDATORS", new InjectionToken(ngDevMode ? 'NgAsyncValidators' : ''));
      /**
...
`;
  ...
  `;
       ...
       * @publicApi
       */
      class ControlEvent {} exports("ControlEvent", ControlEvent);
      /**
      ...
      const UntypedFormGroup = exports("UntypedFormGroup", FormGroup);
      /**
       * @description
       ...
       * @publicApi
       */
      const isFormGroup = exports("isFormGroup", control => control instanceof FormGroup);
      /**
       ...
       * @publicApi
       */
      class FormRecord extends FormGroup {} exports("FormRecord", FormRecord);
      /**
       * @description
       ...
       * @publicApi
       */
      const isFormRecord = exports("isFormRecord", control => control instanceof FormRecord);
      ...
      const FormControl = exports("FormControl", class FormControl extends AbstractControl {
        /** @publicApi */
        defaultValue = null;
        /** @internal */
        _onChange = [];
      ...
      const UntypedFormControl = exports("UntypedFormControl", FormControl);
      /**
       * @description
       ...
       * @publicApi
       */
      const isFormControl = exports("isFormControl", control => control instanceof FormControl);
    ...
    `);
      ...
      const UntypedFormArray = exports("UntypedFormArray", FormArray);
      /**
       * @description
       ...
       * @publicApi
       */
      const isFormArray = exports("isFormArray", control => control instanceof FormArray);
