...
System.register(['@angular/core', 'rxjs/operators', 'rxjs'], (function (exports) {
    ...
    return {
        setters: [function (module) {
            ...
            _ResourceImpl = module.ɵResourceImpl;
            linkedSignal = module.linkedSignal;
            computed = module.computed;
            ResourceStatus = module.ResourceStatus;
            ...
            TransferState = module.TransferState;
            makeStateKey = module.makeStateKey;
            _truncateMiddle = module.ɵtruncateMiddle;
        }, function (module) {
        ...
        execute: (function () {
             ...
             * @publicApi
             */
            class HttpHandler {} exports("HttpHandler", HttpHandler);
            /**
             ...
             * @publicApi
             */
            class HttpBackend {} exports("HttpBackend", HttpBackend);
             ...
             * @publicApi
             */
            var HttpEventType; exports("HttpEventType", HttpEventType);
             ...
             * @publicApi
             */
            const HTTP_INTERCEPTORS = exports("HTTP_INTERCEPTORS", new InjectionToken(ngDevMode ? 'HTTP_INTERCEPTORS' : ''));
            /**
             ...
             */
            const HTTP_ROOT_INTERCEPTOR_FNS = exports("ɵHTTP_ROOT_INTERCEPTOR_FNS", new InjectionToken(ngDevMode ? 'HTTP_ROOT_INTERCEPTOR_FNS' : ''));
            // TODO(atscott): We need a larger discussion about stability and what should contribute to stability.
            // Should the whole interceptor chain contribute to stability or just the backend request #55075?
            // Should HttpClient contribute to stability automatically at all?
            const REQUESTS_CONTRIBUTE_TO_STABILITY = exports("ɵREQUESTS_CONTRIBUTE_TO_STABILITY", new InjectionToken(ngDevMode ? 'REQUESTS_CONTRIBUTE_TO_STABILITY' : '', {
              providedIn: 'root',
              factory: () => true
            }));
            /**
            ...
            } exports({ ɵHttpInterceptingHandler: HttpInterceptorHandler, ɵHttpInterceptorHandler: HttpInterceptorHandler });
            (() => {
             ...
             * @publicApi
             */
            class HttpXsrfTokenExtractor {} exports("HttpXsrfTokenExtractor", HttpXsrfTokenExtractor);
            /**
             ...
             * @publicApi
             */
            var HttpFeatureKind; exports("HttpFeatureKind", HttpFeatureKind);
             ...
             */
            const httpResource = exports("httpResource", (() => {
             ...
             * @publicApi
             */
            const HTTP_TRANSFER_CACHE_ORIGIN_MAP = exports("HTTP_TRANSFER_CACHE_ORIGIN_MAP", new InjectionToken(ngDevMode ? 'HTTP_TRANSFER_CACHE_ORIGIN_MAP' : ''));
            /**
...
//# sourceMappingURL=angular-common-http.js.map
